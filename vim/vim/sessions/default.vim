...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <expr> <BS> coc#_insert_key('request', '0454033b-c6d1-11e9-8ee7-938c4762c04e')
...
nmap ,cg :Scratch
nmap ,cw :call CleanWhiteSpace()
nmap ,clt :ScalcTab
nmap ,clv :ScalcVSplit
nmap ,cls :ScalcSplit
nmap ,cll :Scalc
nmap ,K :call ManualSearch()
nmap ,fs :%!sudo cat > %
nmap ,tg :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q .
nmap ,ct :ConqueTermTab zsh --login
nmap ,cv :ConqueTermVSplit zsh --login
nnoremap ,mr :MRU
nnoremap ,mk :make -j$(grep --count processor /proc/cpuinfo)
nmap ,av :AV
nmap ,hh :A
nmap ,pc :CtrlPClearCache
nmap ,pd :CtrlPDir 
nmap ,qaf :qa!
nmap ,qf :q!
nmap ,qq :q
nmap ,qa :qa
map ,bd :bd!
nmap ,nw :call ToggleWrap()
nmap ,hl :nohlsearch
map ,ps :call TogglePaste()
map ,hc :call ToggleCursorLine()
map ,ad :call ToggleAutochdir()
map ,ms :call ToggleMouse()
map ,gu :GundoToggle
map ,ts :tselect
map ,tb :TagbarToggle
map ,tl :Tlist
map ,nt :NERDTreeToggle
map ,gg :vimgrep // %<Home><Right><Right><Right><Right><Right><Right><Right><Right><Right>
map ,ga :Ack 
...
xnoremap <silent> <SNR>112_(matchup-z%) :call matchup#motion#jump_inside(1)
nnoremap <silent> <Plug>(matchup-z%) :call matchup#motion#jump_inside(0)
onoremap <silent> <Plug>(matchup-[%) :call matchup#motion#op('[%')
onoremap <silent> <Plug>(matchup-]%) :call matchup#motion#op(']%')
xnoremap <silent> <SNR>112_(matchup-[%) :call matchup#motion#find_unmatched(1, 0)
xnoremap <silent> <SNR>112_(matchup-]%) :call matchup#motion#find_unmatched(1, 1)
...
xnoremap <silent> <SNR>112_(matchup-g%) :call matchup#motion#find_matching_pair(1, 0)
onoremap <silent> <Plug>(matchup-%) :call matchup#motion#op('%')
xnoremap <silent> <SNR>112_(matchup-%) :call matchup#motion#find_matching_pair(1, 1)
...
nnoremap <silent> <expr> <SNR>112_(wise) empty(g:v_motion_force) ? 'v' : g:v_motion_force
...
cnoremap  <Up>
imap  :wa
inoremap <silent> <expr> " coc#_insert_key('request', '04540339-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> ' coc#_insert_key('request', '04540338-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> ( coc#_insert_key('request', '04540330-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> ) coc#_insert_key('request', '04540331-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> < coc#_insert_key('request', '04540336-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> > coc#_insert_key('request', '04540337-c6d1-11e9-8ee7-938c4762c04e')
vmap Ë :m'<-2`>my`<mzgv`yo`z
vmap Ê :m'>+`<my`>mzgv`yo`z
nmap Ë mz:m-2`z
nmap Ê mz:m+`z
inoremap <silent> <expr> [ coc#_insert_key('request', '04540332-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> ] coc#_insert_key('request', '04540333-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> ` coc#_insert_key('request', '0454033a-c6d1-11e9-8ee7-938c4762c04e')
cnoremap jk 
inoremap jk 
inoremap <silent> <expr> { coc#_insert_key('request', '04540334-c6d1-11e9-8ee7-938c4762c04e')
inoremap <silent> <expr> } coc#_insert_key('request', '04540335-c6d1-11e9-8ee7-938c4762c04e')
let &cpo=s:cpo_save
unlet s:cpo_save
...
set runtimepath+=~/.vim/bundle/vim-bracketed-paste/
...
set runtimepath+=~/.vim/bundle/fencview/
set runtimepath+=~/.vim/bundle/Gundo/
set runtimepath+=~/.vim/bundle/LargeFile/
set runtimepath+=~/.vim/bundle/vim-easymotion/
set runtimepath+=~/.vim/bundle/Mark/
set runtimepath+=~/.vim/bundle/Rename/
set runtimepath+=~/.vim/bundle/SingleCompile/
set runtimepath+=~/.vim/bundle/nerdcommenter/
set runtimepath+=~/.vim/bundle/ZenCoding.vim/
set runtimepath+=~/.vim/bundle/auto_mkdir/
set runtimepath+=~/.vim/bundle/ctrlp.vim/
set runtimepath+=~/.vim/bundle/tabular/
set runtimepath+=~/.vim/bundle/vim-easy-align/
set runtimepath+=~/.vim/bundle/SwissCalc/
...
set runtimepath+=~/.vim/bundle/vim-protobuf/
...
set smartindent
set smarttab
set statusline=%{coc#status()}%{get(b:,'coc_current_function','')}\ %m%r%h%w\ %<%F\ %=\ [%{strlen(&ft)?&ft:'none'},\ %{strlen(&fenc)?&fenc:'none'},\ %{&fileformat}]\ \ %l/%L:%c\ \ %b-0x%B\ 
set noswapfile
set tabstop=4
...
set whichwrap=b,s,<,>,[,]
set wildignore=*.o,*~,*.pyc,*/.hg/*,*/.svn/*,*/.neocon/*
set wildignorecase
set wildmenu
set nowritebackup
...
silent! normal! zE
let s:l = 171 - ((41 * winheight(0) + 21) / 42)
...
normal! 0
tabnext
edit ~/github/dotfiles/vim/vim/config
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
